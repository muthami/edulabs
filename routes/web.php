...
if(file_exists(storage_path('app/installed.php')))
{
    ...
    Route::prefix('v1/app')->group(function () {
        ...
        Route::post('/payment-stripe', [AppController::class, 'paymentStripe'])->name('app.payment-stripe');
        ...
        Route::get('/ai-image', [AppController::class,'aiImage']);
        ...
        Route::get('/certificate', [AppController::class,'certificate']);
