...
class SuperAdminController extends BaseController
{
    ...
    public function saveSubscriptionPlan(Request $request)
    {
        ...
        $subscription_plan->file_space_limit = $request->input('file_space_limit');
        $subscription_plan->text_token_limit = $request->input('text_token_limit');
        $subscription_plan->image_token_limit = $request->input('image_token_limit');
