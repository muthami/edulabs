    ...
    public function paymentStripe(Request $request)
    {
        ...
        if ($plan) {
            ...
            try {
                ...
                return redirect('/app/billing')->with('status', __('You have successfully subscribed to the plan!'));
...
//        }
    ...
    public function projects()
    {
        ...
        $certificates = Certificate::query()->where('user_id', auth()->id())->get();
    ...
    {
        $certificate = (object)["recipient" => "John Doe",
