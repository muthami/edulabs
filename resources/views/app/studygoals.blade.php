                            ...
                            <li class="list-group-item border-0 flex-column align-items-start ps-0 py-0 mb-3">
                                <div class="checklist-item checklist-item-primary ps-2 ms-3">
                                    ...
                                    <div class="d-flex align-items-center ms-4 mt-1 ps-1">
                                        <div>
                                            <p class="mb-2 font-weight-bold text-sm">{{$todo->reason}}</p>
                                            @if($todo->completed)
                                                <i class="bi bi-trophy-fill" style="color: #0acf83"></i>
                                            @endif
                                            {{__('Created')}}: <span
                                                    class="badge bg-label-success me-3">{{date('d M Y',strtotime($todo->start_date))}}</span>{{__('Finish by')}}
                                            :
