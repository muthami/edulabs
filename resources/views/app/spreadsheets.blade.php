...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="text-dark fw-bolder">{{__('Recent Spreadsheets')}}</h4>
        <div>
                    ...
                    <tr>
                        <td>
                            <a class="text-dark fw-bold"
                               href="{{$base_url}}/app/document?uuid={{$recent_document->uuid}}">{{$document->title}}</a>
                        </td>
                        <td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form novalidate="novalidate" method="post" action="{{route('app.save-document')}}"
                          id="form-install" data-form="redirect" data-btn-id="btn-save-document">
