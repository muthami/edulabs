    ...
    @switch($tab)
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        <form novalidate="novalidate" method="post" action="{{route('app.save-settings')}}"
                              id="form-contact" data-form="refresh" data-btn-id="btn-save-contact">
...
{{--                        </form>--}}
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div>
                <a href="{{$base_url}}/app/user/new" class="btn btn-primary">{{__('Add User')}}</a>
            </div>
        </div>
                            ...
                            <td>
                                <div class="d-flex">
                                    ...
                                    <strong><a class="text-dark"
                                               href="{{$base_url}}/app/user/{{$app_user->uuid}}">{{$app_user->first_name}} {{$app_user->last_name}}</a></strong>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end" style="">
                                        ...
                                        <li><a class="dropdown-item"
                                               href="{{$base_url}}/app/user/{{$app_user->uuid}}">{{__('Edit')}}</a></li>
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h1 class="h3">{{__('Users')}}</h1>
            <div>
                <a href="{{$base_url}}/app/manage-api/new" class="btn btn-primary">{{__('Create API Key')}}</a>
            </div>
        </div>
            ...
            <div class="card-body">
                <table id="app-data-table" class="table table-bordered">
                    ...
                    @foreach($api_keys as $api_key)
                        <tr>
                            <td>
                                <a href="{{$base_url}}/app/manage-api/{{$api_key->uuid}}">{{$api_key->name}}</a>
                            </td>
                            <td>
                            ...
                            <td class="text-end">
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end" style="">
                                        ...
                                        <li><a class="dropdown-item"
                                               href="{{$base_url}}/app/manage-api/{{$api_key->uuid}}">{{__('Edit')}}</a>
                                        </li>
                                        <li><a class="dropdown-item"
                                               href="{{$base_url}}/app/manage-api/{{$api_key->uuid}}?action=regenerate">{{__('Regenerate Key')}}</a>
                                        </li>
                                        ...
                                        @if($api_key->id !== $user->id)
                                            ...
                                            <li><a class="dropdown-item" data-delete-item="true"
                                                   href="{{$base_url}}/app/delete/api-key/{{$api_key->uuid}}">{{__('Delete')}}</a>
                                            </li>
                                        @endif
