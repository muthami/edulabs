    ...
    @switch($tab)
        ...
        <div class="row">
            <div class="col-md-8 mx-auto">
                <div class="card">
                    <div class="card-body">
                        <form novalidate="novalidate" method="post" action="{{route('app.save-quick-share')}}"
                              id="form-share-wizard" data-form="redirect" data-btn-id="btn-save-share">

                            <div class="mb-4">
                                <h4 class="mb-3 text-dark fw-bolder">{{__('New Share Wizard')}}</h4>
                                ...
                                <div>
                                    <div class="form-check form-check-inline mb-3">
                                        <input class="form-check-input share-type" type="radio" name="type"
                                               id="type_url" value="url">
                                        <label class="form-check-label" for="type_url">{{__('A URL')}}</label>
                                    </div>

                                    <div class="form-check form-check-inline mb-3">
                                        <input class="form-check-input share-type" type="radio" checked name="type"
                                               id="type_image" value="image">
                                    ...
                                    <div class="form-check form-check-inline mb-3">
                                        <input class="form-check-input share-type" type="radio" name="type"
                                               id="type_zip_file" value="zip_file">
                                        <label class="form-check-label" for="type_zip_file">{{__('A zip file')}}</label>
                                    </div>

                                    <div class="form-check form-check-inline mb-3">
                                        <input class="form-check-input share-type" type="radio" name="type"
                                               id="type_text_snippet" value="text_snippet">
                                        <label class="form-check-label"
                                               for="type_text_snippet">{{__('A text snippet')}}</label>
                                    </div>
                            ...
                            <button type="submit" class="btn btn-primary d-none"
                                    id="btn-save-share">{{__('Save')}}</button>

                        </form>
                        <div id="block_share_file">
                            <form action="{{route('app.create-quick-share')}}" data-then="redirect" id="app-file-upload"
                                  class="dropzone d-none text-center px-4 py-6 dz-clickable">
                ...
                @if(count($shares))
                    ...
                    <table id="app-data-table" class="table table-bordered">
                        ...
                        @foreach($shares as $share)
                            <tr>
                                <td>
                                    <a href="{{$base_url}}/app/view-share/{{$share->uuid}}">{{$share->title}}</a>
                                </td>
                                <td>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end" style="">
                                            <li><a class="dropdown-item"
                                                   href="{{$base_url}}/app/view-share/{{$share->uuid}}">{{__('Open')}}</a>
                                            </li>
                                            <li>
                                                <hr class="dropdown-divider">
                                            </li>
                                            <li><a class="dropdown-item" data-delete-item="true"
                                                   href="{{$base_url}}/app/delete/quick-share/{{$share->uuid}}">{{__('Delete')}}</a>
                                            </li>
                                        </ul>
                                    </div>
                                </td>
        ...
        @include('app.common.quick-share-access-logs')
