...
@section('content')
    ...
    <div class="row g-4 mt-2">
        <div class="col-md-12">
            <p class="text-muted">Congratulations on achieving the following certificates</p>
            <div class="row">
                @foreach($certificates as $cert)
                    <div class="col-md-3">
                        <a href="{{ url("$base_url/super-admin/certificates/$cert->id/download") }}">
                            <div class="border p-4 rounded-3 cert text-center">
                                <br>
                                <h6 style="font-family: Righteous">{{ $cert->title }}</h6>
                                <h5 class="fw-bold">{{ $cert->user->first_name }} {{ $cert->user->last_name }}</h5>
