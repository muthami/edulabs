                    ...
                    <td>
                        <div class="d-flex">
                            ...
                            <strong><a class="text-dark"
                                       href="{{$base_url}}/app/document?uuid={{$app_user->uuid}}">{{$app_user->first_name}} {{$app_user->last_name}}</a></strong>
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" style="">
                                ...
                                <li><a class="dropdown-item"
                                       href="{{$base_url}}/super-admin/settings?tab=user&current_user={{$app_user->uuid}}">{{__('Edit')}}</a>
                                </li>
