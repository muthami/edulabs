                ...
                <form method="post" action="{{ url('/signup') }}">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="mt-4">
                            ...
                            <input type="text" name="first_name" id="first_name"class="border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-3" placeholder="{{__('Enter your first name')}}" required="">
                        </div>
                        <div class="mt-4">
                            <label for="first_name" class="block mb-2 text-sm font-medium text-gray-900">{{__('Last Name')}}</label>
                            <input type="text"  name="last_name" id="last_name" class="border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-3" placeholder="{{__('Enter your last name')}}" required="">
                        </div>
                    </div>
                        ...
                        <div class="mt-4">
                            ...
                            <input type="email" name="email" id="email" class=" border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-3" placeholder="{{__('Your email address')}}" required="">
                        </div>

                        <div class="mt-4">
                            <label for="account-type" class="block mb-2 text-sm font-medium text-gray-900"> {{__('Sign Up As')}}</label>
                            <select  name="account_type" id="account-type" class="border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-3" required="">
